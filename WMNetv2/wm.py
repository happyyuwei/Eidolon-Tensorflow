...
class WMContainer(pixel_container.PixelContainer):
    ...
    def compute_loss(self, input_image, target):
        ...
        total_loss=total_gen_loss+watermark_total_loss

        loss_set={}

        loss_set["total_gen_loss"] = total_gen_loss
        loss_set["wm_loss"]=watermark_total_loss
    ...
    def on_train_batch(self, input_image, target):
        ...
        #获取可训练的梯度
        generator_variables=self.generator.trainable_variables + self.extractor.trainable_variables
